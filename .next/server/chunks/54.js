...
__webpack_require__.d(__webpack_exports__, {
  "default": () => (/* binding */ PersonalInformation_skills)
});
...
;// CONCATENATED MODULE: ./stores/accaunt/profile/SkillsFormModel.tsx
...
var SkillsFormModel = (_dec = external_mobx_.observable.ref, (_class = /*#__PURE__*/function (_FormModel) {
  inherits_default()(SkillsFormModel, _FormModel);

  var _super = _createSuper(SkillsFormModel);

  //@observable.ref serverActionLogin: ServerActionModel
  function SkillsFormModel() {
    var _this;

    classCallCheck_default()(this, SkillsFormModel);

    _this = _super.call(this);

    initializerDefineProperty_default()(assertThisInitialized_default()(_this), "skill", _descriptor, assertThisInitialized_default()(_this));
  ...
  createClass_default()(SkillsFormModel, [{
    key: "skillName",
    get: function get() {
    ...
    key: "setSkills",
    value: function () {
      var _setSkills = asyncToGenerator_default()( /*#__PURE__*/regenerator_default().mark(function _callee2() {
        var response;
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                _context2.next = 4;
                return (0,fetchUserProfile/* setUserSkills */.C1)(sessionStorage.getItem('auth_token'), (0,fetchUserProfile/* extractFetchUserSetSkillsParams */.X4)(this));
      ...
      function setSkills() {
        return _setSkills.apply(this, arguments);
      }
  ...
  return SkillsFormModel;
}(FormModel/* default */.Z), (_descriptor = applyDecoratedDescriptor_default()(_class.prototype, "skill", [_dec], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: null
}), applyDecoratedDescriptor_default()(_class.prototype, "skillName", [external_mobx_.computed], Object.getOwnPropertyDescriptor(_class.prototype, "skillName"), _class.prototype), applyDecoratedDescriptor_default()(_class.prototype, "hydrate", [external_mobx_.action], Object.getOwnPropertyDescriptor(_class.prototype, "hydrate"), _class.prototype), applyDecoratedDescriptor_default()(_class.prototype, "fetchProfile", [external_mobx_.action], Object.getOwnPropertyDescriptor(_class.prototype, "fetchProfile"), _class.prototype)), _class));

var skills = new SkillsFormModel();
...
;// CONCATENATED MODULE: ./src/ui/Form/SkillsSelect.tsx
...
function fetchSkillsOptions(_x) {
  return _fetchSkillsOptions.apply(this, arguments);
}

function _fetchSkillsOptions() {
  _fetchSkillsOptions = asyncToGenerator_default()( /*#__PURE__*/regenerator_default().mark(function _callee(inputValue) {
    return regenerator_default().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            return _context.abrupt("return", _axios/* default.get */.Z.get('/user/skill', {
              params: {
                name: inputValue
              }
...
var SkillsSelect = function SkillsSelect(_ref) {
  ...
  (0,external_react_.useEffect)(function () {
    fetchSkillsOptions(current).then(function (res) {
...
;// CONCATENATED MODULE: ./pages/user-dashboard/PersonalInformation/skills.tsx
...
var SkillsInformation = (0,external_mobx_react_.observer)(function () {
      ...
      children: [/*#__PURE__*/jsx_runtime_.jsx(WindowHeader/* WindowHeader */.i, {
        ...
        children: /*#__PURE__*/(0,jsx_runtime_.jsxs)("div", {
          ...
          children: [/*#__PURE__*/jsx_runtime_.jsx("ul", {
            ...
            children: profile.skillsInf && profile.skillsInf.map(function (skill) {
              return /*#__PURE__*/(0,jsx_runtime_.jsxs)("div", {
                ...
                children: [/*#__PURE__*/jsx_runtime_.jsx("span", {
                  ...
                  className: "close",
                  onClick: function onClick() {
                    return profile.deleteSkill(skill.id);
                  }
                })]
              });
            })
            ...
            children: /*#__PURE__*/jsx_runtime_.jsx(Buttons/* ButtonForSelection */.BD, {
              text: skills.skill.name || /*#__PURE__*/(0,jsx_runtime_.jsxs)(jsx_runtime_.Fragment, {
                children: ["\u0434\u043E\u0431\u0430\u0432\u0438\u0442\u044C \u043A\u0430\u0442\u0435\u0433\u043E\u0440\u0438\u044E ", /*#__PURE__*/jsx_runtime_.jsx("span", {
                  className: "arrow-right"
                })]
              }),
              onClick: function onClick() {
                modal.openModal( /*#__PURE__*/jsx_runtime_.jsx(SkillsSelect, {
                  object: skills,
            ...
            type: "submit",
            form: "newCareer",
            onClick: function onClick() {//!isFormOpened ? (setFormOpened(true)) : handleSubmit(e)
            },
...
/* harmony default export */ const PersonalInformation_skills = (SkillsInformation);
